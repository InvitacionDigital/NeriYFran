...
const Regalo: React.FC = () => {
  return (
    <div className='mt-12 w-[85%] shadow-lg rounded-2xl flex flex-col justify-center items-center gap-8 py-12 px-6 text-center font-sans bg-primary text-white'>
      ...
      <p>Lo que más queremos es compartir con ustedes nuestro gran día ✨, pero si deseas regalarnos algo puedes hacer clic en el siguiente botón.<br/><strong>¡Muchas gracias!</strong></p>
      <Popup trigger={<button className='mt-4 font-semibold rounded-full p-4 bg-secondary shadow-btn'>VER INFORMACIÓN</button>} modal>
        ...
        <p className="my-6 mx-6 text-6xl font-normal text-center font-dance">Neri y Fran</p>
          ...
          <p className="my-4"><small>Titular: </small>Francisco Jose Prezzio</p>
          <p className="my-4"><small>Banco: </small>Brubank</p>
          <p className="my-4"><small>CBU: </small>1430001713030521790012</p>
          <p className="my-4"><small>Alias: </small>franciscoprezzio</p>
          <p className="my-4"><small>Nº cuenta: </small>1303052179001</p>
          <p className="my-4"><small>CUIT: </small>20-34399851-2</p>
